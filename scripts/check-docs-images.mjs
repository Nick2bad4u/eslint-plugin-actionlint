...
const directory = await mkdtemp(
    join(tmpdir(), "actionlint-image-regressions-")
);
...
/**
 * @param {string} name - Four-byte box type.
 * @param {Buffer} body - Box payload.
 * @param {number} [size] - Declared box length, including its header.
 *
 * @returns {Buffer} The encoded box.
 */
...
/** @type {[string, Buffer, { width: number; height: number }?][]} */
const fixtures = [
