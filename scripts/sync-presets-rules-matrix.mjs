...
const pluginNamespace = builtPlugin.meta?.namespace ?? "actionlint";
const presetDocsByName = {
    all: {
        href: "./all.md",
        icon: "🟣",
        path: resolve("docs", "rules", "presets", "all.md"),
        publicName: "actionlint.configs.all",
    },
    configuration: {
        href: "./configuration.md",
        icon: "🔧",
        path: resolve("docs", "rules", "presets", "configuration.md"),
        publicName: "actionlint.configs.configuration",
    },
    recommended: {
        href: "./recommended.md",
        icon: "🟡",
        path: resolve("docs", "rules", "presets", "recommended.md"),
        publicName: "actionlint.configs.recommended",
    },
    actionlintOnly: {
        href: "./actionlint-only.md",
        icon: "🧪",
        path: resolve("docs", "rules", "presets", "actionlint-only.md"),
        publicName: "actionlint.configs.actionlintOnly",
    },
};
