...
const rawHangingReporterFlag =
    process.env["ACTIONLINT_VITEST_HANGING_PROCESS_REPORTER"] ??
...
/**
 * Vitest configuration for eslint-plugin-actionlint.
 */
    ...
    test: {
        ...
        coverage: {
            ...
            exclude: [
                ...
                "shared",
                "shared/test",
                "src/_internal/actionlint-worker.ts", // Covered through worker integration; V8 cannot merge worker-thread instrumentation here.
