...
const baseUrl =
    environmentVariables["DOCUSAURUS_BASE_URL"] ?? "/eslint-plugin-actionlint/";
const enableExperimentalFaster =
    environmentVariables["DOCUSAURUS_ENABLE_EXPERIMENTAL"] === "true";

const organizationName = "Nick2bad4u";
const projectName = "eslint-plugin-actionlint";
...
const projectTagline = "Actionlint diagnostics inside ESLint.";
...
const pwaTileColor = "#2563eb";
const pwaMaskIconColor = "#2563eb";
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            label: "Bridge Guide",
                            to: "/docs/rules/guides/actionlint-bridge",
                        },
                        {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            label: "Actionlint Only",
                            to: "/docs/rules/presets/actionlint-only",
                        },
                        {
                            label: "Configuration",
